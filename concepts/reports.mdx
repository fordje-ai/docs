...
See the [Reports API reference](/api-reference/reports) for the complete endpoint documentation, including request body schema, response fields, and error handling details.
